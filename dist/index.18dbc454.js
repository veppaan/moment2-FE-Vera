...
async function loadCourses() {
    try {
        ...
        if (!response.ok) throw new Error("Fel vid ladding av data...");
...
function filterData() {
    ...
    //Filtrerar
    const filteredData = courses.filter((course)=>course.coursename.toLowerCase().includes(searchValue.toLowerCase()) || course.code.toLowerCase().includes(searchValue.toLowerCase()) || course.progression.toLowerCase().includes(searchValue.toLowerCase()));
